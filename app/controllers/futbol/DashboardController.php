...
class DashboardController extends \App\Controllers\ModuleController {
    ...
    /**
     * Obtener items del menú de fútbol
     */
            ...
            [
                'items' => [
                    [
                        ...
                        'url' => url('futbol', 'dashboard', 'index'),
                        'active' => true
                    ],
                    [
                        'label' => 'Calendario',
                        'icon' => 'fas fa-calendar-alt',
                        'url' => url('futbol', 'calendario', 'index'),
                        'badge' => '3',
                        'badge_type' => 'warning'
                    ]
                ]
            ...
            [
                'items' => [
                    [
                        ...
                        'url' => '#',
                        'submenu' => [
                            ['label' => 'Listado', 'url' => url('futbol', 'cancha', 'index')],
                            ['label' => 'Nueva Cancha', 'url' => url('futbol', 'cancha', 'crear')],
                            ['label' => 'Tarifas', 'url' => url('futbol', 'tarifa', 'index')]
                        ]
                    ],
                    [
                        'label' => 'Reservas',
                        ...
                        'url' => '#',
                        'submenu' => [
                            ['label' => 'Ver Reservas', 'url' => url('futbol', 'reserva', 'index')],
                            ['label' => 'Nueva Reserva', 'url' => url('futbol', 'reserva', 'crear')],
                            ['label' => 'Historial', 'url' => url('futbol', 'reserva', 'historial')]
                        ]
                    ],
                    [
                        'label' => 'Clientes',
                        'icon' => 'fas fa-users',
                        'url' => url('futbol', 'cliente', 'index')
                    ]
                ]
            ],
            [
                'header' => 'Escuelas & Torneos'
            ],
            [
                'items' => [
                    [
                        'label' => 'Escuelas de Fútbol',
                        'icon' => 'fas fa-graduation-cap',
                        'url' => '#',
                        'submenu' => [
                            ['label' => 'Mis Escuelas', 'url' => url('futbol', 'escuela', 'index')],
                            ['label' => 'Alumnos', 'url' => url('futbol', 'alumno', 'index')],
                            ['label' => 'Horarios', 'url' => url('futbol', 'horario', 'index')]
                        ]
                    ],
                    [
                        'label' => 'Torneos',
                        ...
                        'url' => '#',
                        'submenu' => [
                            ['label' => 'Torneos Activos', 'url' => url('futbol', 'torneo', 'index')],
                            ['label' => 'Crear Torneo', 'url' => url('futbol', 'torneo', 'crear')],
                            ['label' => 'Equipos', 'url' => url('futbol', 'equipo', 'index')]
                        ]
                    ]
                ]
            ],
            ...
            [
                'items' => [
                    ...
                    [
                        ...
                        'url' => '#',
                        'submenu' => [
                            ['label' => 'Ingresos', 'url' => url('futbol', 'reporte', 'ingresos')],
                            ['label' => 'Ocupación', 'url' => url('futbol', 'reporte', 'ocupacion')],
                            ['label' => 'Clientes', 'url' => url('futbol', 'reporte', 'clientes')]
                        ]
                    ]
                ]
            ]
